                        ...
                        <div class="user-options dropdown-box">
                            <div class="drop-content basic">
                                <ul>
                                    ...
                                    <li> <a href="update_student_profile.php"><i class="fa fa-user" aria-hidden="true"></i> Update Profile</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="nano-content">
                            <nav>
                                <ul class="nav nav-left-lines" id="main-nav">
                                    ...
                                    <li class="has-child-item close-item <?=($page == 'message.php'|| $page == 'view_message.php') ? 'open-item' : '' ?>">
                                    <a><i class="fa fa-pencil-square-o" aria-hidden="true"></i><span>Message</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li><a href="message.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Send Message</a></li>
                                        <li><a href="view_message.php"><i class="fa fa-envelope-o" aria-hidden="true"></i>View Message</a></li>
                                    </ul>
                                </li>
