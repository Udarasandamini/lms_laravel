...
<div class="row animated fadeInUp">
    <h4 class="section-subtitle"><b>Students Overview</b></h4>
    <div class="panel">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Delete Button -->
                                <a href="delete_student.php?id=<?= $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this student?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
