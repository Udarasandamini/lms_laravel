...
<div class="modal fade" id="bookedit-<?= $books['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modal-info-label">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header state modal-info">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="modal-info-label"><i class="fa fa-book"></i>Update Book Details</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" style="border:1px solid;padding:10px;" method="post" action="update.php?id=<?= $books['id'] ?>" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                        <label for="bookname" class="col-sm-3 control-label">Book Available</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="bookname" placeholder="Book Available" name="book_avilable" value="<?= $books['book_avilable'] ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
